...
const ImageFormatInterface* GetFormatInterface(const img_lib::Path& path) {
    ...
    static const format_interfaces::ImageFormatJPEG jpegInterface;
    static const format_interfaces::ImageFormatPPM ppmInterface;
    static const format_interfaces::ImageFormatBMP bmpInterface;
